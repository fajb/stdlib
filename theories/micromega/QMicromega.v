...
#[local] Abbreviation Qeval_expr := (PEeval
...
#[local] Abbreviation QWeakChecker := (CWeakChecker
...
#[local] Abbreviation Qnormalise := (Cnormalise
  Q0 Q1 Qplus Qmult Qminus Qopp Qeq_bool Qle_bool).
#[local] Abbreviation Qnegate := (Cnegate
  Q0 Q1 Qplus Qmult Qminus Qopp Qeq_bool Qle_bool).
#[local] Abbreviation qunsat := (check_inconsistent Q0 Qeq_bool Qle_bool).
#[local] Abbreviation qdeduce := (nformula_plus_nformula Q0 Qplus Qeq_bool).
