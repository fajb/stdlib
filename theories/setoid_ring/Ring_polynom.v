...
Section MakeRingPol.
 ...
 #[local] Abbreviation Pol := (Pol C).
 #[local] Abbreviation P0 := (P0 cO).
 #[local] Abbreviation P1 := (P1 cI).
 #[local] Abbreviation Peq := (Peq ceqb).
 #[local] Abbreviation mkX := (mkX cO cI).
 #[local] Abbreviation mkPinj := (@mkPinj C).
 #[local] Abbreviation mkPX := (mkPX cO ceqb).
 #[local] Abbreviation Popp := (Popp copp).
 #[local] Abbreviation PaddC := (PaddC cadd).
 #[local] Abbreviation PsubC := (PsubC csub).
 #[local] Abbreviation Padd := (Padd cO cadd ceqb).
 #[local] Abbreviation PaddI := (PaddI cadd Padd).
 #[local] Abbreviation Psub := (Psub cO cadd csub copp ceqb).
 #[local] Abbreviation PsubI := (PsubI cadd copp Psub).
 #[local] Abbreviation PaddX := (PaddX cO ceqb Padd).
 #[local] Abbreviation PsubX := (PsubX cO copp ceqb Psub).
 #[local] Abbreviation PmulC_aux := (PmulC_aux cO cmul ceqb).
 #[local] Abbreviation PmulC := (PmulC cO cI cmul ceqb).
 #[local] Abbreviation Pmul := (Pmul cO cI cadd cmul ceqb).
 #[local] Abbreviation PmulI := (PmulI cO cI cmul ceqb Pmul).
 ...
 #[local] Abbreviation CFactor := (CFactor cO ceqb cdiv).
 #[local] Abbreviation MFactor := (MFactor cO cI ceqb cdiv).
 #[local] Abbreviation POneSubst := (POneSubst cO cI cadd cmul ceqb cdiv).
 #[local] Abbreviation PNSubst1 := (PNSubst1 cO cI cadd cmul ceqb cdiv).
 #[local] Abbreviation PNSubst := (PNSubst cO cI cadd cmul ceqb cdiv).
 #[local] Abbreviation PSubstL1 := (PSubstL1 cO cI cadd cmul ceqb cdiv).
 #[local] Abbreviation PSubstL := (PSubstL cO cI cadd cmul ceqb cdiv).
 #[local] Abbreviation PNSubstL := (PNSubstL cO cI cadd cmul ceqb cdiv).
 ...
 #[local] Abbreviation PExpr := (PExpr C).
...
#[local] Abbreviation Ppow_pos := (Ppow_pos cO cI cadd cmul ceqb).
#[local] Abbreviation Ppow_N := (Ppow_N cO cI cadd cmul ceqb).
...
Section POWER.
 ...
 Section NORM_SUBST_REC.
  ...
  #[local] Abbreviation norm_aux := (Pol_of_PExpr cO cI cadd cmul csub copp ceqb).
  #[local] Abbreviation norm_subst := (norm_subst cO cI cadd cmul csub copp ceqb cdiv n lmp).
 ...
 End NORM_SUBST_REC.
 #[local] Abbreviation norm_subst := (norm_subst cO cI cadd cmul csub copp ceqb cdiv).
 ...
 #[local] Abbreviation mon_of_pol := (Mon_of_Pol cO ceqb).
 #[local] Abbreviation mk_monpol_list := (mk_monpol_list cO cI cadd cmul csub copp ceqb cdiv).
 #[local] Abbreviation ring_checker := (ring_checker cO cI cadd cmul csub copp ceqb cdiv).
...
Abbreviation norm_aux := Pol_of_PExpr.
