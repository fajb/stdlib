...
(* equality test *)
#[local] Abbreviation PExpr_eq := (PExpr_eq ceqb).
...
#[local] Abbreviation NPEadd := (NPEadd cO cadd ceqb).
#[local] Abbreviation NPEsub := (NPEsub cO csub ceqb).
#[local] Abbreviation NPEopp := (NPEopp copp).
#[local] Abbreviation NPEpow := (NPEpow cO cI (pow_pos cmul) ceqb).
#[local] Abbreviation NPEmul := (NPEmul cO cI cmul (pow_pos cmul) ceqb).
...
#[local] Abbreviation PEsimp := (PEsimp
...
#[local] Abbreviation FExpr := (FExpr C).
...
#[local] Abbreviation linear := (linear C).
...
#[local] Abbreviation absurd_PCond := (absurd_PCond cO).
...
#[local] Abbreviation default_isIn := (default_isIn cO cI (pow_pos cmul) ceqb).
#[local] Abbreviation isIn := (isIn cO cI cmul (pow_pos cmul) ceqb).
...
#[local] Abbreviation split_aux := (split_aux cO cI cmul (pow_pos cmul) ceqb).
#[local] Abbreviation split := (field_checker.split cO cI cmul (pow_pos cmul) ceqb).
...
#[local] Abbreviation Fnorm := (Fnorm
  cO cI cadd cmul csub copp (pow_pos cmul) ceqb).
...
#[local] Abbreviation Fapp := (Fapp Fcons).
...
#[local] Abbreviation Fcons0 := (Fcons0 cO cI cadd cmul csub copp ceqb).
...
#[local] Abbreviation Fcons00 := (Fcons00 cO cI cadd cmul csub copp ceqb).
...
#[local] Abbreviation Fcons1 := (Fcons1 cO cI cadd cmul csub copp ceqb).
...
#[local] Abbreviation Fcons2 := (Fcons2
  cO cI cadd cmul csub copp (pow_pos cmul) ceqb).
...
Abbreviation Fnorm := (fun cO cI cadd cmul csub copp ceqb =>
