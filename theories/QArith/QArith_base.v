...
Abbreviation Q := Q.
Abbreviation Qmake := Qmake.
Abbreviation Qnum := Qnum.
Abbreviation Qden := Qden.
...
Abbreviation Qeq_bool := Qeq_bool.
Abbreviation Qle_bool := Qle_bool.
...
Abbreviation Qplus := Qplus.
Abbreviation Qmult := Qmult.
Abbreviation Qopp := Qopp.
Abbreviation Qminus := Qminus.
Abbreviation Qinv := Qinv.
